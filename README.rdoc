...
No toda el configuración necesaria es de la aplicación Rails, también es necesario configurar un virtual host. En el caso de esta aplicación, se hizo con apache
...
== Autor
Esta aplicación fue desarrollada por Miguel Angel Bravo (@MiguelAngelBrav), y Nicolas Mery (@NicolasMery)
